...
d3.json( "data/points/merged.json", function( dinput ){
...
function updateImage(){
	$("#scatterplot").attr("src","data/points/points_" + $('#frame').val() + ".png");
	select_line('points_'+ $('#frame').val() + '.json');
	$('#current_points').html( $('#frame').val() );
}
